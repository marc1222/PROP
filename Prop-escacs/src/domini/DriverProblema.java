...
public class DriverProblema {
    ...
    public void testEliminarProblema(int id, int njug, String fen, int prim, String idc) {
    ...
    public void testGetProblemaId(int id) {
        ...
        System.out.println(String.valueOf(p.getId()) + " " + String.valueOf(p.getNumJugades()) + " " +
                String.valueOf(p.getPrimer()) + " " + p.getPosIni() + " " +
                String.valueOf(p.getDificultat()) + " " + p.getIdCreador()); //2 3 0 8/8/2Pb2pk/1R1B4/6Pp/5R1K/2r5/8 3
    }
        ...
        while (val != 9) {
            ...
            switch (val) {
                ...
                case 5:
                    ...
                    String idc = String.valueOf(sc.nextInt());
                    dp.testEliminarProblema(id4, njug4, fen4, prim4, idc);
                    break;
                case 6:
